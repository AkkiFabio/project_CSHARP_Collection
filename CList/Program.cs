...
namespace CList
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            listaAnimal.Add(new Animal("Elefante"));
            //Raposa vai ser adicionada (posição 2, começa do 1) e vai ser removida (índice 1, começa do zero)
            listaAnimal.Add(new Animal("Girafa"));
            listaAnimal.Add(new Animal("Urso"));
            listaAnimal.Add(new Animal("Zebra")); // último animal será removido
